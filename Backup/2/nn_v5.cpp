...
class ANN
{
	...
	void Compute_DeltasWithDLRandMoments(float*,float,int,bool);

	void LRAdjust(float**,float**);

	float Compute_BatchDeltas(float**,float**,float,int,int*);
...
//		}
	...
	void ANN::Compute_DeltasWithLayerLr(float *InputPattern,float AlphaPassed)
  	...
  	void ANN::Compute_DeltasWithDLRandMoments(float *InputPattern,float AlphaPassed,int BatchSize,bool LastFrame)
    {
            int SP_thislayer;
...
//            }
	...
	float ANN::Compute_BatchDeltas(float **BGInputLPCC,float **BGOutputLPCC,float AlphaPassed,
